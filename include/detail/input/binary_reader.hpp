...
public:
    ...
    */
    ...
    bool sax_parse(
        const input_format_t format, json_sax_t* sax_, const bool strict = true,
...
private:
    ...
    */
    ...
    bool get_bson_string(const NumberType len, string_t& result)
    {
        ...
        return get_string(input_format_t::bson,
                          len - static_cast<NumberType>(1), result) &&
                             ...
                             const cbor_tag_handler_t tag_handler)
    {
        switch (get_char ? get() : current)
        {
            ...
            case 0x9B:  // array (eight-byte uint64_t for n follow)
            {
                ...
                return get_number(input_format_t::cbor, len) &&
                       get_cbor_array(
                           detail::conditional_static_cast<std::size_t>(len),
                           tag_handler);
            }
                    ...
                    case cbor_tag_handler_t::error:
                    {
                        ...
                        return sax->parse_error(
                            ...
                            parse_error::create(
                                ...
                                exception_message(
                                    input_format_t::cbor,
                                    "invalid byte: 0x" + last_token, "value"),
                                BasicJsonType()));
                    }
                    ...
                    case cbor_tag_handler_t::store:
                    {
                        ...
                        switch (current)
                        {
                            case 0xD8:
                            {
                                ...
                                b.set_subtype(detail::conditional_static_cast<
            ...
            case 0xF9:  // Half-Precision Float (two-byte IEEE 754)
            {
                ...
                if (JSON_HEDLEY_UNLIKELY(
                        !unexpect_eof(input_format_t::cbor, "number")))
                {
                    return false;
                }
    ...
    */
                ...
                return sax->parse_error(
                    ...
                    parse_error::create(
                        ...
                        exception_message(input_format_t::cbor,
                                          ...
                                          "(0x40-0x5B) or indefinite binary "
                                          "array type (0x5F); last byte: 0x" +
                                              last_token,
                                          "binary"),
                        BasicJsonType()));
            }
    ...
    /*!
    @param[in] len  the length of the array or static_cast<std::size_t>(-1) for
    an array of indefinite size
    @param[in] tag_handler how CBOR tags should be treated
    ...
    */
                        ...
                        const cbor_tag_handler_t tag_handler)
    {
        ...
        if (len != static_cast<std::size_t>(-1))
        {
            ...
            {
                if (JSON_HEDLEY_UNLIKELY(
                        !parse_cbor_internal(true, tag_handler)))
                {
                    return false;
                }
            }
        ...
        else
        {
            ...
            {
                if (JSON_HEDLEY_UNLIKELY(
                        !parse_cbor_internal(false, tag_handler)))
                {
                    return false;
                }
            }
    ...
    */
    bool get_ubjson_string(string_t& result, const bool get_char = true)
    {
        ...
        if (JSON_HEDLEY_UNLIKELY(
                !unexpect_eof(input_format_t::ubjson, "value")))
        {
            return false;
        }
                ...
                return sax->parse_error(
                    ...
                    parse_error::create(
                        ...
                        exception_message(input_format_t::ubjson,
                                          "expected length type specification "
                                          "(U, i, I, l, L); last byte: 0x" +
                                              last_token,
                                          "string"),
                        BasicJsonType()));
        }
                ...
                return sax->parse_error(
                    ...
                    parse_error::create(
                        ...
                        exception_message(
                            ...
                            "expected length type specification (U, i, I, l, "
                            "L) after '#'; last byte: 0x" +
                                last_token,
                            "size"),
                        BasicJsonType()));
            }
    ...
    */
    bool get_ubjson_size_type(std::pair<std::size_t, char_int_type>& result)
    {
        ...
        if (current == '$')
        {
            ...
            if (JSON_HEDLEY_UNLIKELY(
                    !unexpect_eof(input_format_t::ubjson, "type")))
            {
                return false;
            }
    ...
    bool get_ubjson_value(const char_int_type prefix)
    {
        switch (prefix)
        {
            ...
            case 'C':  // char
            {
                get();
                if (JSON_HEDLEY_UNLIKELY(
                        !unexpect_eof(input_format_t::ubjson, "char")))
                {
                    return false;
                }
                ...
                string_t s(1,
                           static_cast<typename string_t::value_type>(current));
                return sax->string(s);
            }
        ...
        if (size_and_type.first != string_t::npos)
        {
            ...
            if (size_and_type.second != 0)
            {
                if (size_and_type.second != 'N')
                {
                    ...
                    {
                        if (JSON_HEDLEY_UNLIKELY(
                                !get_ubjson_value(size_and_type.second)))
                        {
                            return false;
                        }
                    }
    ...
    */
    bool get_ubjson_object()
    {
        ...
        if (size_and_type.first != string_t::npos)
        {
            ...
            if (size_and_type.second != 0)
            {
                for (std::size_t i = 0; i < size_and_type.first; ++i)
                {
                    if (JSON_HEDLEY_UNLIKELY(!get_ubjson_string(key) ||
                                             !sax->key(key)))
                    {
                        return false;
                    }
    ...
    bool get_ubjson_high_precision_number()
    {
        ...
        for (std::size_t i = 0; i < size; ++i)
        {
            get();
            if (JSON_HEDLEY_UNLIKELY(
                    !unexpect_eof(input_format_t::ubjson, "number")))
            {
                return false;
            }
