        ...
        switch (j.type())
        {
            ...
            default:
            {
                JSON_THROW(type_error::create(317,
                                              "to serialize to BSON, top-level "
        ...
        switch (j.type())
        {
            ...
            case value_t::number_float:
            {
                ...
                else if (std::isinf(j.m_value.number_float))
                {
                    ...
                    oa->write_character(to_char_type(0xf9));
                    oa->write_character(j.m_value.number_float > 0
                                            ? to_char_type(0x7C)
                                            : to_char_type(0xFC));
                    oa->write_character(to_char_type(0x00));
                }
                ...
                {
                    write_compact_float(j.m_value.number_float,
    ...
    void write_msgpack(const BasicJsonType& j)
    {
        switch (j.type())
        {
            ...
            case value_t::binary:
            {
                ...
                {
                    std::uint8_t output_type = use_ext ? 0xC8   // ext 16
                                                       : 0xC5;  // bin 16
                ...
                {
                    std::uint8_t output_type = use_ext ? 0xC9   // ext 32
                                                       : 0xC6;  // bin 32
                      ...
                      const bool use_type, const bool add_prefix = true)
    {
        switch (j.type())
        {
            ...
            case value_t::binary:
            {
                ...
                {
                    oa->write_character(to_char_type('#'));
                    write_number_with_ubjson_prefix(j.m_value.binary->size(),
                                                    true);
                }
    ...
    */
                                         ...
                                         const bool add_prefix)
    {
        ...
        else
        {
            ...
            {
                oa->write_character(
                    to_char_type('H'));  // high-precision number
            }
            ...
            {
                oa->write_character(
                    to_char_type(static_cast<std::uint8_t>(number[i])));
            }
        }
    }
...
public:
    ...
    static CharType to_char_type(std::uint8_t x) noexcept
    {
        ...
        static_assert(std::is_trivial<CharType>::value,
