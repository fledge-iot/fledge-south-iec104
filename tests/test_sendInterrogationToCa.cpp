...
TEST(IEC104, PluginsendInterrogationCommmandsToCaTest)
{
    IEC104 iec104;
    json_config a;
    ...
    ASSERT_NO_THROW(iec104.sendInterrogationCommmandToCA(41025, 2, 60));
    ASSERT_NO_THROW(iec104.sendInterrogationCommmandToCA(41025, 0, 60));
    ASSERT_NO_THROW(
        iec104.sendInterrogationCommmandToCA(-16546546846565, 0, 60));
}